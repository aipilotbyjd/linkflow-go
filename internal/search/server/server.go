...
import (
	...
	"github.com/linkflow-go/internal/search/adapters/http/handlers"
	"github.com/linkflow-go/internal/search/adapters/indexer"
	"github.com/linkflow-go/internal/search/app/service"
...
type Server struct {
	...
	indexer    ports.IndexerLifecycle
}
...
func New(cfg *config.Config, log logger.Logger) (*Server, error) {
	...
	// Initialize service
	searchService := service.NewSearchService(searchIndexer, eventBus, redisClient, log)
