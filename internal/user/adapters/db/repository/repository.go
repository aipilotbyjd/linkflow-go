...
// ListUsersOptions is kept here for backward compatibility.
// The canonical definition lives in internal/user/ports.
type ListUsersOptions = ports.ListUsersOptions
