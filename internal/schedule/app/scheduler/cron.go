...
type CronScheduler struct {
	cron       *cron.Cron
	repository ports.ScheduleRepository
...
func NewCronScheduler(repo ports.ScheduleRepository, eventBus events.EventBus, redis *redis.Client, logger logger.Logger) *CronScheduler {
